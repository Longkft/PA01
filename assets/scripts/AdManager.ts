...
export class AdManager extends Component {
    ...
    @property(CCString)
    androidLink: string = "https://play.google.com/store/apps/details?id=com.gplay.cartoon.coloring.monster.color";

    @property(CCString)
    iosLink: string = "https://play.google.com/store/apps/details?id=com.gplay.cartoon.coloring.monster.color";

    @property(CCString)
    defaultLink: string = "https://play.google.com/store/apps/details?id=com.gplay.cartoon.coloring.monster.color";
